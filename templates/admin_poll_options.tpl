...
<div class="form-group">{tr}Option{/tr}:<input type="text" name="title" value="{$title|escape}" size="70" /></div>
<div class="form-group submit"><input type="submit" class="btn btn-default" name="save" value="{tr}Save{/tr}" /></div>
</form>
